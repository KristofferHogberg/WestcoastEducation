...
namespace Westcoast_Education_Api.Controllers
{
    ...
    public class CourseController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<List<CourseViewModel>>> ListCourseAsync(int id)
        {
            return Ok(await _repository.GetCourseByIdAsync(id));
        }
        ...
        [HttpGet("category/{id}")]
        public async Task<ActionResult<List<CourseViewModel>>> ListCourseWithCategoryAsync(int id)
        {
            return Ok(await _repository.GetCourseWithCategoryAsync(id));
        }
